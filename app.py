...
if uploaded is not None:
    ...
    if st.button("🚀 开始检查", type="primary", use_container_width=True):
        ...
        try:
            # Step 1
            progress.progress(10, text="Step 1/6: 提取PDF内容...")
            ...
            # Step 2
            progress.progress(20, text="Step 2/6: LLM结构化解析...")
            ...
            ai_review = ""
            if do_ai_review:
                progress.progress(80, text="Step 6/6: AI最终审核...")
            ...
            progress.progress(95, text="生成检查报告...")
...
### 检查内容
1. **计算验证**: 逐条验证累计变化量、变化速率
2. **统计验证**: 验证最大值/最小值/最大速率统计
3. **逻辑检查**: 安全状态判定、汇总表一致性
4. **AI审核**: 由AI专家对检查结果做最终确认
        """)
